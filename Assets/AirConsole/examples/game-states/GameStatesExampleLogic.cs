...
// ReSharper disable Unity.PerformanceCriticalCodeInvocation
    ...
    public class GameStatesExampleLogic : MonoBehaviour {
        ...
        private void Update() {
            logo.transform.Rotate(25 * Time.deltaTime, 5 * Time.deltaTime, 100 * Time.deltaTime);
        }
        ...
        private void OnAirConsolePause() {
            gameIsPausedByAirConsole = true;
            PauseGame();
        }

        private void OnAirConsoleResume() {
            gameIsPausedByAirConsole = false;
            ResumeGame();
        }

        private void PauseAudio() {
            AudioListener.pause = true;
            SetAudioIsPausedState(true);
        }
        ...
        private void SetAudioIsPausedState(bool audioIsPaused) {
            audioStateText.text = audioIsPaused ? "Paused" : "Playing";
        }

        private static JToken GetCurrentScreenState() => AirConsole.instance.GetCustomDeviceState(0);
