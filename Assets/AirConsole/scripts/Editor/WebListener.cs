    ...
    public class WebListener {
        ...
        public void ProcessRequest(object listenerContext) {
            try {
                ...
                string path = startUpPath + Uri.UnescapeDataString(rawUrl);
                ;
                ...
                if (!File.Exists(path)) {
                    ...
                    msg = Encoding.UTF8.GetBytes(
                        "<html><head><title>AirConsole Error</title></head><body><h1>AirWebserver can't find resources!</h1></body></html>");
                } else {
