...
namespace NDream.AirConsole.Editor {
    public abstract class UnityVersionCheck {
        ...
        private static void CheckUnityVersions() {
            ...
            Debug.LogWarning("Unity version warning: Starting Q2 2025, AirConsole Unity Plugin plans to only support currently supported Unity versions, Unity 2022 LTS or Unity 6");
#endif
#endif
